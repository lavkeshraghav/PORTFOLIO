...
const Index = () => {
  ...
  return (
    <div className="mt-[12rem] md:mt-[5rem] md:ml-[8rem] md:mr-[8rem] mr-[1rem] ml-[1rem]  md:flex justify-center items-center">
      <div className="text-center w-[100%]">
        <h2 className="text-3xl font-bold mb-6 custom-font">My Skills Set</h2>
